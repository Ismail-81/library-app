...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'book': '2px 4px 12px rgba(26,24,21,0.15), inset -2px 0 4px rgba(26,24,21,0.1)',
        'card': '0 1px 3px rgba(26,24,21,0.08), 0 4px 16px rgba(26,24,21,0.06)',
        'elevated': '0 4px 24px rgba(26,24,21,0.12), 0 1px 6px rgba(26,24,21,0.08)',
      },
      animation: {
